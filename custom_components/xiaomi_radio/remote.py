...
class XiaomiRemote(RemoteEntity):
    ...
    async def async_send_command(self, command, **kwargs):
        ...
        actionKeys = {
            # 彩灯
            'caideng_on': ['FE0000000000000000000000000800282250003800A900E401C603920FAF138825B64300000000000000000101010101010101010001000000010000010001010100010542074207420687'],
            'caideng_off': ['FE00000000000000000000000009002822510033003F00AD00E401CC03900FAE138825B5540101010101010101020202020202020202020201010102010101000202020102065308530853072E'],
            'caideng_light': ['FE000000000000000000000000080026224E003700AA00E501C9038F0FAB138825B4430000000000000000010101010101010100010101010001000100000000010001054207420639'],
            # 创建电视
